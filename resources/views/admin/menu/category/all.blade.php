              ...
              <div class="card-header">
                <div class="row">
                    <div class="col-md-8 card_title_part">
                        <i class="fab fa-gg-circle"></i>All Menu Category Information
                    </div>  
                    <div class="col-md-4 card_button_part">
                        <a href="{{route('menu.category.add')}}" class="btn btn-sm btn-dark"><i class="fas fa-plus-circle"></i>Add Category</a>
                    </div>  
                </div>
              </div>
              <div class="card-body">
                <table class="table table-bordered table-striped table-hover custom_table">
                  ...
                  <tbody>
                    @foreach($all as $data)
                    <tr>
                      <td>{{$data->menu_category_name}}</td>
                      <td>{{$data->menu_category_slug}}</td>
                      <td>
